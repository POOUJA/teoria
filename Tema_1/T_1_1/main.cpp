/** 
 * @brief Fichero principal del ejemplo de teorÃa T_1_1
 * @file main.cpp
...
/**
 * Funci€n que me devuelve los datos de mi compa“ero en una sola lÃnea
 * @param pareja La pareja para una determinada asignatura
 * @param error C€digo de error que devuelvo si ocurre algo err€neo
