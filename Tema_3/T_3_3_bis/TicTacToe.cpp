...
/**
 * Inicializa los nombres de los jugadores a "p1" y "p2", e inicializa el
 * tablero
 * @brief Constructor por defecto
 */
TicTacToe::TicTacToe ( ): _jugadores{"p1","p2"}, _t(), _turno(0)
{
...
/**
 * Copia los nombres de los jugadores, a quién le corresponde el siguiente turno
 * y el tablero
...
/**
 * Asigna a los jugadores los nombres que se le pasan como parámetros. Inicializa
 * también el tablero
...
/**
 * Asigna los nombres de los jugadores, a quién le corresponde el siguiente
 * turno y el contenido del tablero
